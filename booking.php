                    ...
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="card-body">
                            <form action="code.php" method="POST">
                                ...
                                <div class="mb-3 ">
                                    <label>People</label>
                                    <input type="text" name="people" class="form-control"></input>
                                </div>
                                <div class="mb-3 ">
                                    <label>Phone</label>
                                ...
                                <div class="mb-3 ">
                                    <label>Food</label>
                                    <input type="text" name="food" class="form-control"></input>
                                </div>
                                <div class="mb-3">
                                    <button type="submit" name="submit" class="btn float-end" style="color:white; background-color:#E4950f; width: 360px;; border: radius 4px;">submit</button>
                                </div>
